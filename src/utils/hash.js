export async function sha256Hex(input) {
  ...
  // Güvenli bağlam (HTTPS / localhost / Capacitor https): yerleşik Web Crypto
  ...
  // Güvensiz bağlam (LAN IP üzerinden düz HTTP): crypto.subtle yoktur → saf-JS yedek.
  // Web Crypto ve Node crypto ile birebir aynı sonucu üretir (test edildi).
